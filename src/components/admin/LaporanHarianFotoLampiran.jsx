...
export default function LaporanHarianFotoLampiran({ settings, date, session, showSignature, lampiranFotos }) {
  return (
    <div>
      <h3 className="font-bold mb-1 text-sm uppercase underline text-center">Lampiran: Foto Dokumentasi</h3>
      <p className="font-medium text-center mb-3">Hari/Tanggal: {formatDateIndo(date)} - Sesi {session}</p>
