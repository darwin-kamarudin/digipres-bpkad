...
// Tab "Laporan" pada panel cetak pegawai — konten & logikanya sama persis
// dengan AdminMobileLaporanHarian (badan dokumen resmi dari komponen bersama
// LaporanHarianDocument), hanya panel luarnya (header, bottom nav) memakai
// gaya panel pegawai agar konsisten dengan tab Rekapan Bulanan/Tahunan lain.
export default function UserCetakLaporanHarian({ employees, attendance, statusLocks = [], settings, holidays = [] }) {
